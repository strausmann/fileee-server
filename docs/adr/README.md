...
- **Nummerierung:** fortlaufend `NNNN` (4-stellig), Dateiname `NNNN-kebab-slug.md`. Nummern werden **nie wiederverwendet** — auch nicht für abgelöste/verworfene ADRs. Die Zählung setzt die von go-fileee übernommene Nummer `0008` fort (nächstes neues ADR in diesem Repo: `0011`).
